...
public class main {
    ...
    static void lihat() throws IOException{
        for(int i = 0 ; i < Mobil.size();i++){
            ...
            System.out.println(" Nama    : "+ Mobil.get(i).getNama_penyewa());
            System.out.println(" Merk    : "+ Mobil.get(i).getMerk_mobil());    
            System.out.println(" Jenis   : "+ Mobil.get(i).getJenis_mobil());
    ...
    static void ubah() throws IOException{
        ...
        Mobil.get(index).setNama_penyewa (nama_penyewa);
        Mobil.get(index).setMerk_mobil (merk_mobil);
        Mobil.get(index).setJenis_mobil  (jenis_mobil);
        Mobil.get(index).setHarga (harga);
