...
final class Manual extends mobil {
    private final String bahan_bakar;
    private boolean berjalan;
   
    
public Manual(String nama_penyewa,String merk_mobil,int harga, String ukuran_mobil, String tujuan, String bahan_bakar){
  ...
  public final void display(){
      ...
      System.out.println("Bebahan bakar            : " + this.bahan_bakar);
}
  public void penyewa(){
