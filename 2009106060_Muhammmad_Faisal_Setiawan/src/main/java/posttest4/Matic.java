...
public class Matic extends mobil {
    private String ukuran_mobil;
    private String tujuan;
    
public Matic(String nama_penyewa,String merk_mobil,int harga, String ukuran_mobil, String tujuan){
